...
async function generateWithClaude(
  ...
  const contentTypes = [
    ...
    {
      name: 'シナリオ型',
      hook: '作品のシチュエーションそのものをミニ物語として語るフック。例：「妻が旅行中に〜」「職場で一番地味だと思ってた彼女が〜」',
      style: `
禁断感・背徳感のある状況設定を2〜3行のミニストーリーとして語る。
構造：
  1行目：「〇〇はダメだと思ってる。でも〜」「〇〇なのに〇〇なんて反則だろ」など読み手を引き込む矛盾・背徳フレーズ
  2〜3行目：作品のシチュエーション（登場人物・関係性・場面）を物語として語る。例「妻の親友が訪ねてきた夜、二人きりになって〜」
  最後：AV女優名を「AV女優名：〇〇」または「出演：〇〇」で明記 → 「リプ欄へ👇」
例文の雰囲気（これを参考にして。そのままコピーはしない）：
  「不倫はダメだと頭ではわかってる。でもなぜか気持ち良い。妻が出張中、久しぶりに連絡してきた元カノと…AV女優名：〇〇 / リプ欄へ👇」`,
    },
  ];
